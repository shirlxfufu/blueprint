...
import { CompilerOptions } from "./compilerImpl";
/**
...
export declare class Documentalist<T> {
    private options;
    private plugins;
    /**
     ...
     */
    static create(options?: CompilerOptions): Documentalist<{}>;
    constructor(options?: CompilerOptions, plugins?: Array<PluginEntry<T>>);
    /**
     ...
     */
    use<P>(pattern: RegExp | string, plugin: Plugin<P>): Documentalist<T & P>;
    /**
     * Returns a new instance of Documentalist with no plugins.
     */
    clearPlugins(): Documentalist<{}>;
    /**
     ...
     */
    documentFiles(files: File[]): Promise<T>;
    /**
