...
const npm_1 = require("./plugins/npm");
...
documentalist_1.Documentalist.create()
    .use(".ts", new typescript_1.TypescriptPlugin())
    .use("package.json", new npm_1.NpmPlugin())
    .documentGlobs(path.join(__dirname, "..", "package.json"), 
