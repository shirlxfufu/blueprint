...
const addBumpPositionalFn = function (yargs, additionalKeywords = []) {
...
export default {
    ...
    builder: (yargs, composed) => {
        const opts = {
            ...
            'generate-release-notes': {
                describe: 'Provides an alternative to create a GitHub release by letting GitHub automatically generate the name and body for the new release.',
                type: 'boolean',
            },
            'ignore-changes': {
                describe: [
        ...
        if (composed) {
            ...
            addBumpPositional = addBumpPositionalFn(yargs);
        }
        yargs.options(opts);
    ...
    handler: async (argv) => {
        try {
            ...
            throw new Error(`"@lerna-lite/version" is optional and was not found. Please install it with "npm install @lerna-lite/version -D". ${err}`);
        }
    },
};
