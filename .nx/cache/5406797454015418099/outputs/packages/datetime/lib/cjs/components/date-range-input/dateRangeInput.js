...
class DateRangeInput extends dateFnsLocalizedComponent_1.DateFnsLocalizedComponent {
    ...
    render() {
        ...
        return ((0, jsx_runtime_1.jsx)(core_1.Popover, { isOpen: this.state.isOpen, placement: "bottom-start", ...popoverProps, autoFocus: false, className: (0, classnames_1.default)(common_1.Classes.DATE_RANGE_INPUT, popoverProps.className, this.props.className), content: popoverContent, enforceFocus: false, onClose: this.handlePopoverClose, popoverClassName: (0, classnames_1.default)(common_1.Classes.DATE_RANGE_INPUT_POPOVER, popoverProps.popoverClassName), ref: popoverRef, renderTarget: this.renderTarget }));
    }
    validateProps(props) {
        if (props.value === null) {
