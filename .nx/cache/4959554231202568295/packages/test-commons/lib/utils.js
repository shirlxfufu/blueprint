 ...
 * chrome tests.
 */
export function dispatchTestKeyboardEvent(target, eventType, key, shift = false) {
...
export function dispatchMouseEvent(target, eventType = "click", clientX = 0, clientY = 0) {
...
export function dispatchTouchEvent(target, eventType = "touchstart", clientX = 0, clientY = 0) {
 ...
 */
export function expectPropValidationError(Component, props, errorMessage, assertionMessage) {
    const { defaultProps = {} } = Component;
    // HACKHACK: weird casts ahead
    expect(() => new Component(Object.assign(Object.assign({}, defaultProps), props))).to.throw(errorMessage, assertionMessage);
}
