...
(0, vitest_1.describe)("<Box>", () => {
    ...
    (0, vitest_1.it)("should render as a div by default", () => {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(box_1.Box, { children: "Test" }));
        const box = react_1.screen.getByText(/test/i);
        (0, vitest_1.expect)(box.tagName).toBe("DIV");
    });
    (0, vitest_1.it)("should pass through data attributes", () => {
    ...
    (0, vitest_1.it)("should support style", () => {
    ...
    (0, vitest_1.it)("should support computed class names", () => {
    ...
    (0, vitest_1.it)("should attach ref", () => {
    ...
    (0, vitest_1.it)("should not support unsupported/invalid props in types", () => {
    ...
    (0, vitest_1.describe)("asChild", () => {
        (0, vitest_1.it)("should render as child with asChild prop", () => {
        ...
        (0, vitest_1.it)("should merge styles with asChild prop", () => {
        ...
        (0, vitest_1.it)("should remove margin on wrapped component", () => {
