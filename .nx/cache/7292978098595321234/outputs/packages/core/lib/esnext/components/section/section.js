...
export const Section = forwardRef((props, ref) => {
    ...
    return (_jsxs(Card, { className: classNames(className, Classes.SECTION, {
        ...
        }), elevation: elevation, ref: ref, "aria-labelledby": sectionTitleId, ...htmlProps, id: sectionId, children: [title && (_jsxs("div", { className: classNames(Classes.SECTION_HEADER, {
