...
export class TabTitle extends AbstractPureComponent {
    ...
    render() {
        ...
        return (_jsxs("div", { ...removeNonHTMLProps(htmlProps), "aria-controls": tabPanelId, "aria-disabled": disabled, "aria-expanded": selected, "aria-selected": selected, className: classNames(Classes.TAB, className), "data-tab-id": id, id: tabTitleId, onClick: disabled ? undefined : this.handleClick, role: "tab", tabIndex: disabled ? undefined : selected ? 0 : -1, children: [icon != null &&
                    icon !== false &&
                    (typeof icon === "string" ? (_jsx(Icon, { icon: icon, intent: intent, className: Classes.TAB_ICON })) : (React.cloneElement(icon, {
                        className: classNames(Classes.TAB_ICON, icon.props.className),
                    }))), title, children, tagContent != null && (_jsx(Tag, { minimal: true, intent: intent, ...tagProps, className: classNames(Classes.TAB_TAG, tagProps?.className), children: tagContent }))] }));
    }
