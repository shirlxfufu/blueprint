...
export const Overlay2 = forwardRef((props, forwardedRef) => {
    ...
    const transitionGroup = (_jsx("div", { "aria-live": "polite", className: classNames(Classes.OVERLAY, {
            [Classes.OVERLAY_OPEN]: isOpen,
            [Classes.OVERLAY_INLINE]: !usePortal,
        }, className), onKeyDown: handleContainerKeyDown, ref: containerElement, children: _jsx(TransitionGroup, { appear: true, component: null, children: childrenWithTransitions }) }));
    if (usePortal) {
