...
export class Dialog extends AbstractPureComponent {
    ...
    maybeRenderHeader() {
        ...
        return (_jsxs("div", { className: Classes.DIALOG_HEADER, children: [_jsx(Icon, { icon: icon, size: IconSize.STANDARD, "aria-hidden": true, tabIndex: -1 }), _jsx(H6, { id: this.titleId, children: title }), this.maybeRenderCloseButton()] }));
    }
}
