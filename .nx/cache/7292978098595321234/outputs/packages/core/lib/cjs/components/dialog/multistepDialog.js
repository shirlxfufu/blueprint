...
class MultistepDialog extends common_1.AbstractPureComponent {
    ...
    renderDialogStep = (step, index) => {
        ...
        return ((0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)(common_1.Classes.DIALOG_STEP_CONTAINER, {
                ...
                onKeyDown: (0, utils_1.clickElementOnKeyPress)(["Enter", " "]), children: [(0, jsx_runtime_1.jsx)("div", { className: common_1.Classes.DIALOG_STEP_ICON, children: stepNumber }), (0, jsx_runtime_1.jsx)("div", { className: common_1.Classes.DIALOG_STEP_TITLE, children: step.props.title })] }) }, index));
    };
