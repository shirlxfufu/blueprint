...
export const PanelStack = (props) => {
    ...
    const panels = panelsToRender
        ...
        return (_jsx(CSSTransition, { classNames: Classes.PANEL_STACK, timeout: 400, children: _jsx(PanelView, { onClose: handlePanelClose, onOpen: handlePanelOpen, panel: panel, previousPanel: stack[index + 1], showHeader: showPanelHeader }) }, key));
    })
        .reverse();
