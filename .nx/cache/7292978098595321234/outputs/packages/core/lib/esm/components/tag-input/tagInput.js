...
export class TagInput extends AbstractPureComponent {
    ...
    render() {
        ...
        return (_jsxs("div", { className: classes, onBlur: this.handleContainerBlur, onClick: this.handleContainerClick, children: [_jsx(Icon, { className: Classes.TAG_INPUT_ICON, icon: leftIcon, size: isLarge ? IconSize.LARGE : IconSize.STANDARD }), _jsxs("div", { className: Classes.TAG_INPUT_VALUES, children: [values.map(this.maybeRenderTag), this.props.children, autoResize ? _jsx(ResizableInput, { ...resolvedInputProps }) : _jsx("input", { ...resolvedInputProps })] }), this.props.rightElement] }));
    }
