...
export class Overlay extends AbstractPureComponent {
    ...
    render() {
        ...
        const transitionGroup = (_jsx("div", { "aria-live": "polite", className: containerClasses, onKeyDown: this.handleKeyDown, ref: this.containerElement, children: _jsx(TransitionGroup, { appear: true, component: null, children: childrenWithTransitions }) }));
        if (usePortal) {
