...
export class Select extends AbstractPureComponent {
    ...
    render() {
        ...
        return (_jsx(QueryList, { ...restProps, menuProps: { "aria-label": "selectable options", ...menuProps, id: this.listboxId }, onItemSelect: this.handleItemSelect, ref: this.handleQueryListRef, renderer: this.renderQueryList }));
    }
    ...
    renderQueryList = (listProps) => {
        ...
        const input = (_jsx(InputGroup, { "aria-autocomplete": "list", leftIcon: _jsx(Search, {}), placeholder: placeholder, rightElement: this.maybeRenderClearButton(listProps.query), ...inputProps, inputRef: this.handleInputRef, onChange: listProps.handleQueryChange, value: listProps.query }));
