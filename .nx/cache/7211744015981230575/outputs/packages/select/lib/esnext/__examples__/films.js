 ...
 */
export function getFilmItemProps(film, { handleClick, handleFocus, modifiers, query, ref }) {
    return {
 ...
 */
export const renderFilm = (film, props) => {
    if (!props.modifiers.matchesPredicate) {
        return null;
    }
    return _jsx(MenuItem, { ...getFilmItemProps(film, props) });
};
/**
 * Renders a menu item to create a single film from a given query string.
 */
export const renderCreateFilmMenuItem = (query, active, handleClick) => (_jsx(MenuItem, { icon: "add", text: `Create "${query}"`, roleStructure: "listoption", active: active, onClick: handleClick, shouldDismissPopover: false }));
/**
 * Renders a menu item to create one or more films from a given query string.
 */
export const renderCreateFilmsMenuItem = (query, active, handleClick) => (_jsx(MenuItem, { icon: "add", text: `Create ${printReadableList(query)}`, roleStructure: "listoption", active: active, onClick: handleClick, shouldDismissPopover: false }));
/**
