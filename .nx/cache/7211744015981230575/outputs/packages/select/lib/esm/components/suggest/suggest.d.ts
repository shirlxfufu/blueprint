 ...
 */
export declare class Suggest<T> extends AbstractPureComponent<SuggestProps<T>, SuggestState<T>> {
    ...
    componentDidUpdate(prevProps: SuggestProps<T>, prevState: SuggestState<T>): void;
