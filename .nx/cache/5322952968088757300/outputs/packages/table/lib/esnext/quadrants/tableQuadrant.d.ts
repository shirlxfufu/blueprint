...
export declare class TableQuadrant extends AbstractComponent<TableQuadrantProps> {
    static defaultProps: Partial<TableQuadrantProps>;
    render(): import("react/jsx-runtime").JSX.Element;
    protected validateProps(nextProps: TableQuadrantProps): void;
