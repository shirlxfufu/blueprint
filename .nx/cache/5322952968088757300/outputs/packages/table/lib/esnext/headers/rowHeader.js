...
export class RowHeader extends Component {
    ...
    wrapCells = (cells) => {
        ...
        return (_jsx("div", { style: { height: tableHeight }, children: _jsx("div", { className: Classes.TABLE_ROW_HEADERS_CELLS_CONTAINER, style: style, children: cells }) }));
    };
    ...
    renderGhostCell = (index, extremaClasses) => {
        ...
        return (_jsx(RowHeaderCell, { className: classNames(extremaClasses), index: index, loading: this.props.loading, style: { height: `${rect.height}px` } }, Classes.rowIndexClass(index)));
    };
...
export function renderDefaultRowHeader(rowIndex) {
    return _jsx(RowHeaderCell, { index: rowIndex, name: `${rowIndex + 1}` });
}
