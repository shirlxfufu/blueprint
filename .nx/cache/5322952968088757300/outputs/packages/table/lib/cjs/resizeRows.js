...
const resizeRowsByApproximateHeightDefaults = {
    ...
    getCellHorizontalPadding: 2 * locator_1.LocatorImpl.CELL_HORIZONTAL_PADDING,
    getNumBufferLines: 1,
};
/**
...
function resizeRowsByApproximateHeight(numRows, columnWidths, getCellText, options) {
    ...
    for (let rowIndex = 0; rowIndex < numRows; rowIndex++) {
        ...
        for (let columnIndex = 0; columnIndex < numColumns; columnIndex++) {
            ...
            const approxCellHeight = utils_1.Utils.getApproxCellHeight(cellText, columnWidths[columnIndex], approxCharWidth, approxLineHeight, horizontalPadding, numBufferLines);
