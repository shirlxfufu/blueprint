...
class Table extends core_1.AbstractComponent {
    ...
    renderMenu = (refHandler) => {
        ...
        return ((0, jsx_runtime_1.jsx)("div", { className: classes, ref: refHandler, onMouseDown: this.handleMenuMouseDown, children: this.maybeRenderRegions(this.styleMenuRegion) }));
    };
