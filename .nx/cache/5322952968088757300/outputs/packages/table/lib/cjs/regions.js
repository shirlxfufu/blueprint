...
exports.Regions = exports.TableLoadingOption = exports.RowLoadingOption = exports.ColumnLoadingOption = exports.SelectionModes = exports.RegionCardinality = void 0;
...
})(RegionCardinality || (exports.RegionCardinality = RegionCardinality = {}));
/**
...
})(ColumnLoadingOption || (exports.ColumnLoadingOption = ColumnLoadingOption = {}));
var RowLoadingOption;
(function (RowLoadingOption) {
    RowLoadingOption["CELLS"] = "cells";
    RowLoadingOption["HEADER"] = "row-header";
})(RowLoadingOption || (exports.RowLoadingOption = RowLoadingOption = {}));
...
})(TableLoadingOption || (exports.TableLoadingOption = TableLoadingOption = {}));
/**
 * Table Regions API.
 *
...
class Regions {
    ...
    static getRegionFromFocusedRegion(focusedRegion) {
    ...
    static sparseMapCells(cells, mapper) {
        ...
        const result = utils_1.Utils.times(numRows, () => new Array(numCols));
    ...
    static joinStyledRegionGroups(selectedRegions, otherRegions, focusedRegionOrCell) {
        const focusedRegion = focusedRegionOrCell == null
            ...
            : "type" in focusedRegionOrCell
                ? focusedRegionOrCell
                : { ...focusedRegionOrCell, type: cellTypes_1.FocusMode.CELL };
        let regionGroups = [];
