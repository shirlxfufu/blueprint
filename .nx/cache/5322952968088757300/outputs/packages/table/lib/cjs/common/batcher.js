 ...
 */
class Batcher {
    static DEFAULT_ADD_LIMIT = 20;
    static DEFAULT_UPDATE_LIMIT = 20;
    static DEFAULT_REMOVE_LIMIT = 20;
    static ARG_DELIMITER = "|";
    currentObjects = {};
    oldObjects = {};
    batchArgs = {};
    done = true;
    ...
    idleCallback(callback) {
        if (!this.callback) {
            ...
            (0, requestIdleCallback_1.requestIdleCallback)(this.handleIdleCallback);
        }
    }
