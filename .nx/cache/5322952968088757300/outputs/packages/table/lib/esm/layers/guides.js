...
export class GuideLayer extends Component {
    ...
    render() {
        ...
        return (_jsxs("div", { className: classNames(className, Classes.TABLE_OVERLAY_LAYER), children: [verticals, horizontals] }));
    }
    renderVerticalGuide = (offset, index) => {
        ...
        return _jsx("div", { className: className, style: style }, index);
    };
