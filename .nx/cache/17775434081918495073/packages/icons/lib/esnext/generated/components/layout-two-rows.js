...
export const LayoutTwoRows = React.forwardRef((props, ref) => {
    const isLarge = (props.size ?? IconSize.STANDARD) >= IconSize.LARGE;
    const pixelGridSize = isLarge ? IconSize.LARGE : IconSize.STANDARD;
    const translation = `${-1 * pixelGridSize / 0.05 / 2}`;
    const style = { transformOrigin: "center" };
    return (_jsx(SVGIconContainer, { iconName: "layout-two-rows", ref: ref, ...props, children: _jsx("path", { d: isLarge ? "M0 380A20 20 0 0 0 20 400H380A20 20 0 0 0 400 380V240A20 20 0 0 0 380 220H20A20 20 0 0 0 0 240zM0 160A20 20 0 0 0 20 180H380A20 20 0 0 0 400 160V20A20 20 0 0 0 380 0H20A20 20 0 0 0 0 20z" : "M0 120A20 20 0 0 0 20 140H300A20 20 0 0 0 320 120V20A20 20 0 0 0 300 0H20A20 20 0 0 0 0 20zM0 300A20 20 0 0 0 20 320H300A20 20 0 0 0 320 300V200A20 20 0 0 0 300 180H20A20 20 0 0 0 0 200z", fillRule: "evenodd", transform: `scale(0.05, -0.05) translate(${translation}, ${translation})`, style: style }) }));
});
LayoutTwoRows.displayName = `Blueprint6.Icon.LayoutTwoRows`;
