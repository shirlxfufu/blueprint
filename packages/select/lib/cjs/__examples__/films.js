...
exports.filterFilm = exports.renderCreateFilmsMenuItem = exports.renderCreateFilmMenuItem = exports.renderFilm = exports.TOP_100_FILMS = void 0;
 ...
 */
function getFilmItemProps(film, itemProps) {
 ...
 */
const renderFilm = (film, props) => {
    if (!props.modifiers.matchesPredicate) {
        return null;
    }
    return (0, jsx_runtime_1.jsx)(core_1.MenuItem, { ...getFilmItemProps(film, props) }, film.rank);
};
exports.renderFilm = renderFilm;
/**
 * Renders a menu item to create a single film from a given query string.
 */
const renderCreateFilmMenuItem = (query, active, handleClick) => ((0, jsx_runtime_1.jsx)(core_1.MenuItem, { icon: "add", text: `Create "${query}"`, roleStructure: "listoption", active: active, onClick: handleClick, shouldDismissPopover: false }));
 ...
 */
const renderCreateFilmsMenuItem = (query, active, handleClick) => ((0, jsx_runtime_1.jsx)(core_1.MenuItem, { icon: "add", text: `Create ${printReadableList(query)}`, roleStructure: "listoption", active: active, onClick: handleClick, shouldDismissPopover: false }));
