...
class QueryList extends core_1.AbstractComponent {
    static displayName = `${core_1.DISPLAYNAME_PREFIX}.QueryList`;
    static defaultProps = {
        disabled: false,
        resetOnQuery: true,
    };
    ...
    constructor(props) {
        ...
        this.listId = props.listId ?? core_1.Utils.uniqueId("bp-query-list");
        const { query = "" } = props;
    ...
    renderItemList = (listProps) => {
        ...
        return ((0, jsx_runtime_1.jsxs)(core_1.Menu, { role: "listbox", ...listProps.menuProps, ulRef: listProps.itemsParentRef, children: [createFirst && createItemView, menuContent, !createFirst && createItemView] }));
    };
