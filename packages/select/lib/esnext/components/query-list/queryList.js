 ...
 */
export class QueryList extends AbstractComponent {
    ...
    renderItemList = (listProps) => {
        ...
        return (_jsxs(Menu, { role: "listbox", ...listProps.menuProps, ulRef: listProps.itemsParentRef, children: [createFirst && createItemView, menuContent, !createFirst && createItemView] }));
    };
