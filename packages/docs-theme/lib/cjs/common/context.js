...
exports.DocumentationContext = exports.hasKssData = exports.hasNpmData = exports.hasTypescriptData = void 0;
...
exports.DocumentationContext = (0, react_1.createContext)({
    getDocsData: () => ({}),
    renderBlock: (_block) => undefined,
    renderType: (type) => type,
    renderViewSourceLinkText: (entry) => entry.sourceUrl,
    showApiDocs: () => void 0,
});
