...
exports.handleNumberChange = exports.handleValueChange = exports.handleStringChange = exports.handleBooleanChange = exports.createKeyEventHandler = void 0;
...
function handleValueChange(handler) {
    return (event) => handler(event.target.value);
}
