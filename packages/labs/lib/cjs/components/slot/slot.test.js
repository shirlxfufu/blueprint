...
(0, vitest_1.describe)("<Slot>", () => {
    (0, vitest_1.test)("merges props into a single child", () => {
    ...
    (0, vitest_1.test)("merges className and style", () => {
    ...
    (0, vitest_1.test)("forwards ref to the child", () => {
    ...
    (0, vitest_1.test)("returns null if no children are provided", () => {
        const { container } = (0, react_1.render)((0, jsx_runtime_1.jsx)(slot_1.Slot, {}));
        (0, vitest_1.expect)(container.firstChild).toBeNull();
    });
    (0, vitest_1.test)("throws an error when multiple children are provided", () => {
