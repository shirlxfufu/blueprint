...
(0, vitest_1.describe)("<Flex>", () => {
    ...
    (0, vitest_1.test)("should always set display flex", () => {
        (0, react_1.render)((0, jsx_runtime_1.jsx)(flex_1.Flex, { children: "Test" }));
        const flex = react_1.screen.getByText(/test/i);
        (0, vitest_1.expect)(flex).toHaveClass(`${NS}-flex`);
    });
    (0, vitest_1.test)("should pass through Box props", () => {
    ...
    (0, vitest_1.test)("should support style prop", () => {
    ...
    (0, vitest_1.test)("should support asChild prop", () => {
    ...
    (0, vitest_1.test)("should support all flex-related props", () => {
