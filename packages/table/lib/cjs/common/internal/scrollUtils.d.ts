 ...
 * cardinality.
 */
export declare function getScrollPositionForRegion(region: Region, currScrollLeft: number, currScrollTop: number, getLeftOffset: (columnIndex: number) => number, getTopOffset: (rowIndex: number) => number, numFrozenRows?: number, numFrozenColumns?: number): {
    scrollLeft: number;
    scrollTop: number;
};
/**
