 ...
 */
class Draggable extends react_1.PureComponent {
    static defaultProps = {
        preventDefault: true,
        stopPropagation: false,
    };
    events = new dragEvents_1.DragEvents();
    ...
    componentDidUpdate(prevProps) {
        const didEventHandlerPropsChange = !core_1.Utils.shallowCompareKeys(prevProps, this.props, {
