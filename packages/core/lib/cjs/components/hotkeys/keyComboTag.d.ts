...
export declare class KeyComboTagInternal extends AbstractPureComponent<KeyComboTagInternalProps> {
...
export declare const KeyComboTag: React.ComponentType<KeyComboTagProps>;
export {};
