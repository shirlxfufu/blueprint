...
export function toDateHourMinuteString(date) {
 ...
 */
export function createTimeObject(hour, minute = 0, second = 0, millisecond = 0) {
...
export function assertTimeIs(time, hours, minutes, seconds, milliseconds) {
...
export function assertDatesEqual(a, b) {
